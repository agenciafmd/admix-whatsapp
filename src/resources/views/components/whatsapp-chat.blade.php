<div class="whatsapp-chat">
  ...
  <label for="whatsapp-chat-is-open"
         title="{{ __('Fechar o chat do WhatsApp') }}"
  ...
  <div class="whatsapp-chat-window">
    <div class="whatsapp-chat-header">
      ...
      <div class="whatsapp-chat-contact-info">
        <strong>{{config('admix-whatsapp.'.$locale.'.atendent')}}</strong>
        <small>
          {{ config('admix-whatsapp.'.$locale.'.occupation') }}
          •
          <span class="text-wa-light-green">{{ __('Online') }}</span>
        </small>
      </div>
      <label for="whatsapp-chat-is-open"
             title="{{ __('Fechar o chat do WhatsApp') }}"
  ...
  <label for="whatsapp-chat-is-open"
         title="{{ __('Abrir o chat do WhatsApp') }}"
